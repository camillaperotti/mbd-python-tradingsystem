...
def main():
    ...
    with col_logo:
        st.image("App/images/logo_w.png", width=400)  
    with col_text:
    ...
    ##
    st.markdown("""
    ## DataRock - Data-driven Financial Advisors 💡
    Welcome to **DataRock**, a platform designed for **data-driven financial advisory**.  
    We provide **advanced market insights and predictive analytics** for **brokers and individual investors**,  
    helping them make informed trading decisions using **machine learning and financial modeling**.
    """)
