...
if __name__ == "__main__":
    ...
    parser.add_argument("--raw_data", type=str, default=raw_data_path, help="Path to raw data CSV file")
    parser.add_argument("--output_data", type=str, default=processed_data_path, help="Path to save processed data")
